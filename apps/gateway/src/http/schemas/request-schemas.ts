...
const wsTunnelAgentConfigSchema = z.object({
  ...
  timeoutMs: z.number().int().positive().optional(),
  // relayToken is auto-generated by AgentService on registration.
  // Clients do not need to supply it; an absent or empty token is replaced
  // by the service before the aggregate is persisted.
